  ...
  r_theme_content <-
    c(
      ...
      # Dynamically create primary sequence from first few non-white/black colors
      {
        ...
        paste0("SPROuT_primary_sequence <- c(", primary_seq, ")")
      },
      "",
      ...
      # Create diverging palette using first color, white, and last color
      {
        if (length(non_neutral_colors) >= 2) {
          ...
          paste0('SPROuT_diverging <- c("', first_color, '", "', white_color, '", "', last_color, '")')
        } else {
          paste0('SPROuT_diverging <- c("', non_neutral_colors[1], '", "', colors$white, '", "', non_neutral_colors[1], '")')
        }
      },
      "",
      ...
      {
        text_color <- resolve_semantic_color("textColor", if ("black" %in% names(colors)) colors$black else "#000000")
        paste0('    text = ggplot2::element_text(family = SPROuT_base_font, colour = "', text_color, '"),')
      },
      {
        ...
        paste0('    plot.title = ggplot2::element_text(family = SPROuT_heading_font, colour = "', heading_color, '", face = "', fonts$ggplot$plotTitleFace, '", size = ggplot2::rel(', fonts$ggplot$plotTitleSize, ")),")
      },
      {
        text_color <- resolve_semantic_color("textColor", if ("black" %in% names(colors)) colors$black else "#000000")
        paste0('    plot.subtitle = ggplot2::element_text(family = SPROuT_base_font, colour = "', text_color, '", size = ggplot2::rel(', fonts$ggplot$plotSubtitleSize, ")),")
      },
      {
        text_color <- resolve_semantic_color("textColor", if ("black" %in% names(colors)) colors$black else "#000000")
        paste0('    axis.title = ggplot2::element_text(family = SPROuT_base_font, colour = "', text_color, '", size = ggplot2::rel(', fonts$ggplot$axisTitleSize, ")),")
      },
      {
        text_color <- resolve_semantic_color("textColor", if ("black" %in% names(colors)) colors$black else "#000000")
        paste0('    axis.text = ggplot2::element_text(family = SPROuT_base_font, colour = "', text_color, '", size = ggplot2::rel(', fonts$ggplot$axisTextSize, ")),")
      },
      {
        text_color <- resolve_semantic_color("textColor", if ("black" %in% names(colors)) colors$black else "#000000")
        paste0('    legend.title = ggplot2::element_text(family = SPROuT_base_font, colour = "', text_color, '", size = ggplot2::rel(', fonts$ggplot$legendTitleSize, ")),")
      },
      {
        text_color <- resolve_semantic_color("textColor", if ("black" %in% names(colors)) colors$black else "#000000")
        paste0('    legend.text = ggplot2::element_text(family = SPROuT_base_font, colour = "', text_color, '", size = ggplot2::rel(', fonts$ggplot$legendTextSize, ")),")
      },
      {
        ...
        paste0('    strip.text = ggplot2::element_text(family = SPROuT_heading_font, colour = "', heading_color, '", face = "', fonts$ggplot$stripTextFace, '"),')
      },
      "    ",
      "    # Background elements",
      {
