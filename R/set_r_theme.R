...
colors_primary_sequence <- c("#cccccc", "#415280", "#8a5697")

# Diverging color palette (for diverging data)
colors_diverging <- c("#cccccc", "#ffffff", "#6c6934")

# Text and background colors
presentation_text_color <- "#000000"
presentation_background_color <- "#ffffff"
presentation_accent_color <- "#8a5697"

# Define typography (based on presentation brand guidelines)
# Using registered font names from sysfonts
presentation_base_font <- "internal_body"
presentation_heading_font <- "internal_heading"
presentation_mono_font <- "internal_mono"
...
theme_presentation <- function(base_size = text_size_base,
  ...
  ggplot2::theme(
    # Text elements
    text = ggplot2::element_text(family = presentation_base_font, colour = "#000000"),
    plot.title = ggplot2::element_text(family = presentation_heading_font, colour = "#000000", face = "bold", size = ggplot2::rel(1.4)),
    plot.subtitle = ggplot2::element_text(family = presentation_base_font, colour = "#000000", size = ggplot2::rel(1.1)),
    axis.title = ggplot2::element_text(family = presentation_base_font, colour = "#000000", size = ggplot2::rel(1)),
    axis.text = ggplot2::element_text(family = presentation_base_font, colour = "#000000", size = ggplot2::rel(0.9)),
    legend.title = ggplot2::element_text(family = presentation_base_font, colour = "#000000", size = ggplot2::rel(1)),
    legend.text = ggplot2::element_text(family = presentation_base_font, colour = "#000000", size = ggplot2::rel(0.9)),
    strip.text = ggplot2::element_text(family = presentation_heading_font, colour = "#000000", face = "bold"),
